 ...
 * <TestUserLoader />
    ...
    Note: This component was created by Claude 4.5 for testing purposes.
    Prompt: "Create a React Native component that provides buttons to load test users
    by their user IDs. It should have buttons to load an admin user and a regular test user.
    Use the useUser context to load specific users. Include loading states and error handling."
